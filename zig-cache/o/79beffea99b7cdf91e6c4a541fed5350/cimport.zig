...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/darl/.local/bin/zig-linux-x86_64/lib/include/stdarg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/darl/.local/bin/zig-linux-x86_64/lib/include/stdarg.h:18:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /home/darl/.local/bin/zig-linux-x86_64/lib/include/stdarg.h:19:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/darl/.local/bin/zig-linux-x86_64/lib/include/stdarg.h:24:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/darl/.local/bin/zig-linux-x86_64/lib/include/stdarg.h:27:9
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /home/darl/.local/bin/zig-linux-x86_64/lib/include/stddef.h:104:9
...
pub const LUA_API = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/luaconf.h:282:9
pub const LUAI_FUNC = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/luaconf.h:310:9
pub const l_floor = @compileError("unable to translate macro: undefined identifier `floor`"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/luaconf.h:403:9
pub const lua_numbertointeger = @compileError("unable to translate C expr: expected ')' instead got '='"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/luaconf.h:417:9
pub const l_floatatt = @compileError("unable to translate macro: undefined identifier `DBL_`"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/luaconf.h:460:9
pub const lua_str2number = @compileError("unable to translate macro: undefined identifier `strtod`"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/luaconf.h:469:9
...
pub const lua_getlocaledecpoint = @compileError("unable to translate macro: undefined identifier `localeconv`"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/luaconf.h:656:9
pub const LUAI_MAXALIGN = @compileError("unable to translate macro: undefined identifier `n`"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/luaconf.h:766:9
...
pub const luaL_newlibtable = @compileError("unable to translate C expr: unexpected token '('"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/lauxlib.h:127:9
pub const luaL_addchar = @compileError("TODO postfix inc/dec expr"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/lauxlib.h:207:9
pub const luaL_addsize = @compileError("unable to translate C expr: expected ')' instead got '+='"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/lauxlib.h:211:9
pub const luaL_buffsub = @compileError("unable to translate C expr: expected ')' instead got '-='"); // /home/darl/Projects/meshbox-zig/lib/ziglua/lib/lua-5.4.4/src/lauxlib.h:213:9
